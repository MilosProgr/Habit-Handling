...
namespace DevHabit.Api.Migrations.Application
{
    ...
    [Migration("20250801093609_AutomationSource-Add")]
    partial class AutomationSourceAdd
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DevHabit.Api.Entities.Habit", b =>
                {
                    ...
                    b.Property<int>("_automationSource")
                        .HasColumnType("integer")
                        .HasColumnName("_automation_source");
            ...
            modelBuilder.Entity("DevHabit.Api.Entities.User", b =>
                {
                    ...
                    b.HasIndex("IdentifyId")
                        .IsUnique()
                        .HasDatabaseName("ix_users_identify_id");
