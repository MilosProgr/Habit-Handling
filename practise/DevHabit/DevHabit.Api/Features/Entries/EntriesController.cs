...
using AuthConstants = DevHabit.Api.Common.Auth.AuthConstants;

namespace DevHabit.Api.Features.Entries;
    ...
    LinkService linkService) : ControllerBase
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            var cursor = EntryCursorDto.Decode(encodedCursor);
        ...
        var items = paginationResult.Data.ToList();
    ...
    public async Task<IActionResult> GetStats(CancellationToken cancellationToken)
    {
        ...
        var dates = entries.Select(x => x.Date)
